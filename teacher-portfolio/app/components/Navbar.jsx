...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Drawer */}
      <div className={`fixed inset-0 z-40 md:hidden transition-all duration-500 ${menuOpen ? "pointer-events-auto" : "pointer-events-none"}`}>
        {/* Backdrop */}
        <div
          onClick={() => setMenuOpen(false)}
          className={`absolute inset-0 bg-stone-900/40 backdrop-blur-sm transition-opacity duration-400 ${menuOpen ? "opacity-100" : "opacity-0"}`}
        />
